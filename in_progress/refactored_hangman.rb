...
def clear_screen()
  # if system is Unix use the "clear" command to clear the screen, else for Windows use "cls"
...
def letter_test(letter)
  ...
  # wrong_letter broke here?

  # if the letter is in the word pass it to find_locations(), if not pass it to wrong_letter()
